...
func (p *GoParser) TypeLit() (localctx ITypeLitContext) {
	...
	case 1:
		localctx = NewIgnContext(p, localctx)
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(634)
			p.ArrayType()
	...
	case 2:
		localctx = NewDeclStructContext(p, localctx)
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(635)
			p.StructType()
...
func NewParamResultContext(parser antlr.Parser, ctx antlr.ParserRuleContext) *ParamResultContext {
	var p = new(ParamResultContext)

	p.SignatureContext = NewEmptySignatureContext()
	p.parser = parser
	p.CopyFrom(ctx.(*SignatureContext))
...
func (p *GoParser) Signature() (localctx ISignatureContext) {
	...
	case 1:
		localctx = NewParamResultContext(p, localctx)
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(701)
			p.Parameters()
